...
PROMPT = (
    ...
    "roughly 40% of the canvas width and 70% of the canvas height, "
    ...
    "card face and clearly CONNECTED to a scaled knuckle ridge running "
    "down the right side. Four claws total — absolutely NO detached "
    "floating claws, NOTHING above the top edge of the card, the area "
    "above the card is completely empty. NO WRIST, NO ARM, NO FOREARM. "
