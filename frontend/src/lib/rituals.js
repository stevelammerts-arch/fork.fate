...
export const HEISTS = [
  ...
  { key: "gulls", name: "Mine! Mine! Mine!", realm: "Summer", accent: "#FCD34D", desc: "Five curious seagull heads pop out one by one around the medallion's rim, squawking their claim — then a gull swoops off with the whole medallion in its feet." },
  { key: "splat", name: "Splat!", realm: "Summer", accent: "#F1EEE2", desc: "A passing gull scores a direct hit on the banner glass — SPLAT — and a windshield wiper squeaks out of nowhere to wipe the mess clean." },
  { key: "fireflies", name: "The Firefly Drift", realm: "Fairy Gully", accent: "#FFD166", desc: "Wild fireflies stray into the gully and drift blinking across the dark, flashing their slow code until the swarm moves on." },
  { key: "coinrain", name: "The Coin Spill", realm: "Dragon's Hoard", accent: "#E6B23A", desc: "Somewhere above the hoard a purse tips over — gold coins tumble down from the banner, flipping end over end, and pile up on the floor before sinking into the treasure." },
  { key: "watcher", name: "The Watcher", realm: "Steampunk", accent: "#7CE08A", desc: "A green-eyed head leans in from the edge of the screen and quietly watches what you're up to... then slips back into the dark. First the left side. Then the right." },
  { key: "chase", name: "Code 3", realm: "Cyberscape", accent: "#FF2D55", desc: "A runner tears across the skyline flat out — a unit right on its bumper, lights blazing, siren wailing — gone as fast as it came." },
