...
export default function InstallAppButton() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-transparent px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-white/10"
    >
