...
export default function Home() {
  ...
  const runShuffle = (pool) => {
    ...
    if (rareFate) {
      ...
      // steampunk crank gear, tiki cocktail shaker.
      const pool2 = theme === "fairy" ? ["scratch", "8ball", "wheel", "wand"] : theme === "cyber" ? ["scratch", "8ball", "wheel", "hack", "code"] : theme === "steam" ? ["scratch", "8ball", "wheel", "crank"] : theme === "tiki" ? ["scratch", "8ball", "wheel", "shaker"] : ["scratch", "8ball", "wheel"];
